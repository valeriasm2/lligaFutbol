# Generated by Django 5.2 on 2026-02-27 14:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=100)),
                ('equip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='futbol.equip')),
            ],
        ),
        migrations.AddField(
            model_name='equip',
            name='lliga',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='futbol.lliga'),
        ),
        migrations.CreateModel(
            name='Partit',
            fields=[
